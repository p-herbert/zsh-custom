...
alias pt-worker="pt --min-time '5 day ago' --force-color -- -nginx -DEBUG sunsama-worker | lnav -q"
alias pt-notifications="pt --min-time '5 day ago' --force-color -- -nginx -DEBUG sunsama-notifications | lnav -q"
